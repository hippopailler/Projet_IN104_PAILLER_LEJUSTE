...
// l'affichage en question mêle un peu de Unicode (\u2534) et beaucoup de UTF-8 (fonction en trypique de type \xE2\x94\x8C)
...
void afficher2(CouleurPion** grille) {
    ...
    for (int i = 0; i < 5; ++i) {
        ...
        for (int j = 0; j < 5; ++j) {
            ...
            // les resets servent à remettre la couleur en blanc, sinon la couleur bleu se propage (en soit on peut s'amuser avec les couleurs)
            switch (grille[i][j]) {
                case BLANC:
                    printf(". "); // Case vide
                    break;
        ...
        if (i < 4) {
            ...
            printf("   \xE2\x94\x94\xE2\x94\x80\xE2\x94\x80\xE2\x94\x80\u2534\xE2\x94\x80\xE2\x94\x80\xE2\x94\x80\u2534\xE2\x94\x80\xE2\x94\x80\xE2\x94\x80\u2534\xE2\x94\x80\xE2\x94\x80\xE2\x94\x80\u2534\xE2\x94\x80\xE2\x94\x80\xE2\x94\x80\xe2\x94\x98\n");
        }
    }
    printf("\n");
}
